...
import AutomatedWithdrawFlow from "@/components/withdraw/AutomatedWithdrawFlow";
        ...
        <div className="relative z-10 min-h-[80vh] flex items-center justify-center p-4">
          <div className="max-w-md w-full text-center p-8 bg-black/50 rounded-2xl border border-red-500/30 backdrop-blur-sm shadow-[0_0_20px_rgba(239,68,68,0.3)]">
            <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-full flex items-center justify-center border border-red-500/30 shadow-[0_0_15px_rgba(239,68,68,0.2)]">
              <TrendingDown className="h-10 w-10 text-red-400 drop-shadow-[0_0_10px_rgba(239,68,68,0.5)]" />
            </div>
            ...
            <p className="text-gray-400 mb-6 text-sm sm:text-base">
              Connect your wallet or authenticate with Vincent to withdraw assets
            </p>
            <div className="text-xs sm:text-sm text-gray-500 space-y-2">
              ...
              <div>Or authenticate with Vincent for automated withdrawals</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 p-6">
        <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-red-400 via-white to-orange-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(239,68,68,0.3)] mb-2">
                    Withdraw Protected Assets
                  </h1>
                  <p className="text-gray-300 text-sm sm:text-base flex items-center gap-2">
                    <Shield className="h-4 w-4 text-red-400" />
                    Withdraw your assets from GuardX vault with automated processing
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Automated Withdrawal Form */}
            <div className="lg:col-span-2">
              <AutomatedWithdrawFlow />
            </div>
                ...
                {vaultLoading ? (
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      {vaultAssets.length}{" "}
                      {vaultAssets.length === 1 ? "asset" : "assets"} available for withdrawal
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="p-6 bg-black/50 rounded-2xl border border-gray-800/50 backdrop-blur-sm glow-border">
                ...
                {vaultLoading ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-400">
                      No assets in vault to withdraw
                    </p>
                    <p className="text-xs text-gray-500">
                      Deposit assets first to enable withdrawals
                    </p>
                  </div>
                )}
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-300">
                      Automatic PKP Funding
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-red-400 rounded-full animate-pulse"></div>
                    <span className="text-sm text-gray-300">
                      Vault Asset Withdrawal
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-red-400 rounded-full animate-pulse"></div>
